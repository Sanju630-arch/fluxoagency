              ...
              >
                <Card variant="glass" className="relative overflow-hidden group">
                  ...
                  <div className="relative z-10">
                    <div className="w-24 h-24 mx-auto mb-5 rounded-full bg-primary/10 flex items-center justify-center text-4xl">
                      {member.initials}
                    </div>
                    ...
                    <p className="text-white/70 text-center text-sm">{member.bio}</p>
                    
                    <div className="flex justify-center space-x-3 mt-6">
                      {member.linkedin && (
                        <a href={member.linkedin} target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center text-white hover:bg-primary/20 transition-colors">
                      ...
                      {member.twitter && (
                        <a href={member.twitter} target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center text-white hover:bg-primary/20 transition-colors">
                          <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
